...
- Last 2 years: 3.88 (18.1 out of 20)
...
- Mohammadi, P., Malakouti, M., Suratgar, A., Menhaj, M., "Eye Pupil Control Analysis." *Vision Research Journal* (Under Review). [DOI: 10.21203/rs.3.rs-4504934/v1](https://doi.org/10.21203/rs.3.rs-4504934/v1)
...
**Eye Pupil Control Analysis – DIOR Lab**  
*Oct 2022 – Mar 2023*  
...
- Supervisor: Dr. Amir Abolfazl Suratgar (Amirkabir University of Technology, Tehran, Iran)
...
- **Linear Control Systems - Electrical Engineering**  
  *Feb 2023 – Jul 2023*  
...
- **Programming:**  
  VHDL, Verilog, HSPICE, Python, C/C++, HTML/CSS, JavaScript, Matlab, Simulink, Assembly

- **Machine Learning:**  
  NLP, NER, Semantic Analysis, Vision-Language, LLM, NLTK, Speech Processing, ASR, ESPNet, Computer Vision, Segmentation, Object detection, Classical AI Algorithms

- **Tools:**  
  ISE Design Suite, Vivado Design Suite, IP Core, HLS, Vitis, Micro Blaze, Proteus 8, PCB Design (Altium Designer), STM32 Microcontroller, Cadence (VLSI Designer), Microwind, Arduino, Linux, Git, Docker, Jupyter Notebook, LaTeX

---

## Selected Projects

- **Multi-Layer Perceptron (MLP) Implementation on FPGA:**  
  Developed and trained an MLP for speech recognition implemented on a Virtex-E 2000 FPGA. Quantized the model for 8-bit calculations achieving 83.4% accuracy on the test set.

- **Heart Rate Calculation Using FPGA:**  
  Implemented a MicroBlaze microprocessor on an FPGA with 8 GPIO ports using Vivado and Vitis. Programmed MicroBlaze using Vivado HLS for efficient heart rate calculations.
...
- **CPU simulation on FPGA:**  
  Designed and simulated a CPU with MIPS architecture in a 4-stage pipeline. Implemented RAM, ROM, ALU, and I/O interfaces.

- **Bachelor thesis: Chest X-ray Images Diagnosis and Report Generation:**  
  Fine-tuned Mini-Gemini (a pre-trained VLM) on a large dataset of radiology images for a Visual Question Answering (VQA) task. Created a new dataset of paired images and reports achieving significant performance improvements on the test set.  
  Supervisor: Dr. Saeed Sharifian

- **Gender Classifier Model Development:**  
  Trained a MobileNet architecture model using Keras and TensorFlow on a merged dataset from five large image datasets with gender labels. Achieved 92.7% accuracy on the test set and deployed the model on a personal website using Django. [Link to project](#).
...
- **Machine Learning** - Dr. Andrew Ng
- **Django for Everybody** - Dr. Charles Severance
- **Analysis of Intelligent Biomedical Images** - Dr. Mohammad H Rohban
- **Deep Learning Specialization:**
  - Convolutional Neural Networks
  - Sequence Models (Transformers) - Dr. Andrew Ng
...
- **Member of "Amirkabir 2021 International Summer School" Executive Team**  
  *Mar – Sep 2021*  
  - Invited Dr. Larry Cheng from Penn State University to participate in the summer school. Assisted Dr. Larry Cheng during the summer school sessions.
...
- **Participated in a charity market**  
  *Feb 2024*  
...
- Won 1st place prize in the IEEE Open Data Hackathon Competition. [Certificate](#) *Nov 2022*
- Ranked among top teams in Irancell Labs AI Hackathon. [Certificate](#) *Aug 2023*
